...
module baudrate_generator (
    ...
    always @(*) begin
        ...
        if (counter_reg == 100_000_000 / 9600 / 16 - 1) begin  // constant value
...
module transmitter (
    ...
    always @(*) begin
        state_next        = state;
        data_tmp_next     = data_tmp_reg;  // latch 방지용
        tx_next           = tx_reg;
...
module receiver (
    ...
    always @(*) begin
        ...
        case (state)
            ...
            STOP: begin
                if (br_tick) begin
                    if (br_cnt_reg == 15) begin // transmitter와 done신호 타이밍 맞춰주려고 +8 해줌
                        br_cnt_next  = 0;
                        state_next   = IDLE;
                        rx_done_next = 1'b1;
                    end else begin
