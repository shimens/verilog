...
HD_PWD='D:/ish/verilog/vivadoWS/240516_UART_HW/240516_UART_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_uart.tcl
