...
HD_PWD='D:/ish/verilog/vivadoWS/240516_UART_HW/240516_UART_HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_uart.tcl -notrace
