...
HD_PWD='D:/ish/verilog/vivadoWS/240510_counter/240510_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UpCounter_clock.tcl -notrace
