...
HD_PWD='D:/ish/verilog/vivadoWS/240510_counter/240510_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UpCounter_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UpCounter_clock.tcl
