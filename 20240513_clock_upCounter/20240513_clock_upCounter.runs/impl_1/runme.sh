...
HD_PWD='D:/ish/verilog/vivadoWS/20240513_clock_upCounter/20240513_clock_upCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockUpCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockUpCounter.tcl -notrace
