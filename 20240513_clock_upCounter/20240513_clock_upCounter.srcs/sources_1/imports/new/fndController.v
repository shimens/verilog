...
module fndController (
 ...
 digitSplitter U_DigitSplitter (
    ...
    digitSplitter_sec U_DigitSplitter_sec (
        .i_digit(digit),
        .o_digit_1(w_digit_1),
        .o_digit_10(w_digit_10)
    );

        digitSplitter_min U_DigitSplitter_min (
        .i_digit(digit),
        .o_digit_100(w_digit_100),
        .o_digit_1000(w_digit_1000)
    );
...
module digitSplitter_min (
    input  [13:0] i_digit,
    output [ 3:0] o_digit_100,
    output [ 3:0] o_digit_1000
);
    assign o_digit_100 = i_digit  % 10;
    assign o_digit_1000 = i_digit / 10 % 10;
endmodule
