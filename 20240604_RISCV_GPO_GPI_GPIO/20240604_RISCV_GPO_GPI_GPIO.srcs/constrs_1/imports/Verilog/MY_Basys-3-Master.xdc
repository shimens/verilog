...
# set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; #IO_L5P_T0_34               ,Sch=SW8
# set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { sw[1] }]; #IO_L2N_T0_34               ,Sch=SW9
# set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { sw[2] }]; #IO_L1N_T0_34               ,Sch=SW10
# set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { sw[3] }]; #IO_L2P_T0_34               ,Sch=SW11
