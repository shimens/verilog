...
module DataPath (
    ...
    logic [31:0] w_ALUResult, w_RegFileRData1, w_RegFileRData2, w_PC_Data, w_UI_Adder, w_PC_Adder, w_J_Adder;
...
module extend (
    ...
    always_comb begin
        case (extType)
            ...
            3'b011: immext = {instr[31], instr[30:20], instr[19:12], 12'b0};
            3'b100: immext = {{12{instr[31]}}, instr[19:12], instr[20], instr[30:25], instr[24:21], 1'b0};
