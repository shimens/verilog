...
HD_PWD='D:/ish/verilog/vivadoWS/20240508_Gates/20240508_Gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gatees.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gatees.tcl -notrace
