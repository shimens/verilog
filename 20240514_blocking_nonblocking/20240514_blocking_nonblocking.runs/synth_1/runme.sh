...
HD_PWD='D:/ish/verilog/vivadoWS/20240514_blocking_nonblocking/20240514_blocking_nonblocking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledToggle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledToggle.tcl
