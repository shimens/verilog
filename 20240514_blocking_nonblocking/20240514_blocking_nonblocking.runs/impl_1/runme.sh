...
HD_PWD='D:/ish/verilog/vivadoWS/20240514_blocking_nonblocking/20240514_blocking_nonblocking.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledToggle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledToggle.tcl -notrace
