...
HD_PWD='D:/ish/verilog/vivadoWS/240514_upCounter_hw/240514_upCounter_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log upCounter_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source upCounter_hw.tcl
