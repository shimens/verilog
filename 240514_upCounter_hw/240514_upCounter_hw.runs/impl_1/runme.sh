...
HD_PWD='D:/ish/verilog/vivadoWS/240514_upCounter_hw/240514_upCounter_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log upCounter_hw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source upCounter_hw.tcl -notrace
